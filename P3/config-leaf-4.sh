#!/bin/bash
# ============================================================
# Configuration du VTEP jerdos-p1router-4 (Leaf)
# ============================================================
# Connexions:
# - eth0: vers Route Reflector (jerdos-p1router-1 eth2)
# - eth1: vers jerdos-p1basic-3 (L2 via bridge)
# ============================================================

echo "========================================="
echo "Configuration de jerdos-p1router-4 (VTEP/Leaf)"
echo "========================================="
...
# Interface vers jerdos-p1basic-3 (via eth1, L2 uniquement)
ip link set eth1 up

echo "   Loopback: 1.1.1.4/32"
echo "   eth0: 10.1.1.10/30 (vers RR)"
echo "   eth1: (L2 vers jerdos-p1basic-3)"
...
echo ""
echo "========================================="
echo "Configuration de jerdos-p1router-4 terminée!"
echo "========================================="
